...
# Creating a defenition to clean the data
def clean(a):
    """
...
Pop_Edu = full_data[full_data["Indicator Code"].isin(Ind_list)]  #check the filter in dataframe
Pop_Edu = Pop_Edu.set_index(["Country Code"]) #set index
Pop_Edu #shows the filtered dataframe


# plot for the Population growth for the below mentioned countries
...
pd.DataFrame(In)
Ind = In.rename(columns={375:'SP.URB.TOTL', 907:'SP.POP.TOTL',1173:'SP.POP.GROW',2237:'SH.DYN.MORT',15010:'EG.ELC.ACCS.ZS'})
